...
export default function Edit({ userData }: { userData: UserDataType }) {
    const { roles, userRoles } = usePage<RoleProps>().props;

    const { data, setData, processing } = useForm<UserFormValues>({
        name: userData.name,
    ...
    console.log('OBJECt:', userRoles[0]);
                            ...
                            <form onSubmit={handleFormSubmit}>
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="col-span-2 md:col-span-0">
                                        ...
                                        <Select value={data.active == '1' ? '1' : '0'} onValueChange={(e) => setData('status', e)}>
